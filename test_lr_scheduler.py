# This script tests different learning rate scheduling strategies on the performance of a neural network model (AlexNet) using PyTorch.
...
def main():
    ...
    for scheduler_name in schedulers:
        ...
        with open(results_dir / 'scheduler_results.csv', 'w', newline='') as f:
        ...
        plt.yscale('log')
        plt.grid(True)
        plt.savefig(results_dir / f'lr_curve_{scheduler_name}.png')
        plt.close()
